               ...
               <div class="invoice-box">
                   <table cellpadding="0" cellspacing="0">
                               ...
                               <table>
                                   ...
                                   <tr>
                                       ...
                                       <td class="fs14">
                                            <p>
                                                ${
                                                  data?.metadata?.renterName
                                                } <br />
                                                ${
                                                  data?.metadata?.renterEmail
                                                } <br />
                                                ${
                                                  data?.metadata
                                                    ?.renterPhoneNumber
                       ...
                       <table>
                           ...
                           <tr class="item">
                               <td>Check in</td>
                               <td>${checkInOnlyDate}</td>
                           </tr>
                           <tr class="item">
                               <td>Check out</td>
                               <td>${checkOutOnlyDate}</td>
                           </tr>
                           <tr class="item">
                               <td>Stay days</td>
                               <td>${data?.metadata?.stayDays}</td>
                           </tr>
                           <tr class="item">
                               <td>Guest</td>
                               <td>Adults: ${data?.metadata?.adults}, Children: ${data?.metadata?.children}, Infants: ${data?.metadata?.infants}, pets: ${data?.metadata?.pets}</td>
                           </tr>
                           <tr class="item">
                               <td>Currency</td>
                               <td>${data.currency}</td>
                       ...
                       <table>
                           ...
                           <tr class="item">
                               <td>Per night</td>
                               <td>$${data?.metadata?.originalPrice}</td>
                           </tr>
                           <tr class="item">
                               <td>Discount percentage</td>
                               <td>${data?.metadata?.discountPercentage}%</td>
                           </tr>
                           <tr class="item">
                               <td>($${data?.metadata?.originalPrice} * ${data?.metadata?.stayDays}) Nights</td>
                               <td>$${data?.metadata?.originalPrice * data?.metadata?.stayDays}</td>
                           </tr>
                           <tr class="item">
                               <td>Long stay discount</td>
                               <td>$${data?.metadata?.discountAmount}</td>
                           </tr>
                           <tr class="item">
                               <td>UK-BD service fee</td>
                               <td>$${data?.metadata?.serviceFee}</td>
                           </tr>
                       </table>
                       <tr class="information">
                           <td colspan="2">
                                               ...
                                               <div class="invoiceInfo">
                                                   <table>
                                                       <tr>
                                                           ...
                                                           <td class="fs14" width="140">
                                                               <span class="totalPrice">$${data?.metadata?.actualPrice}</span> <br />
                                                           </td>
                                                       </tr>
                                                   </table>
                                               </div>
